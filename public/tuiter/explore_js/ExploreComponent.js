    ...
    return(`
            <div class="row  mb-2 mt-0">
               <div class="input-group">
                    ...
                    <input type="text" class=" w-50 shadow-none border-0 bg-white rounded-pill form-control ml-0" placeholder="Search Tuiter" aria-label="Search Tuiter" aria-describedby="basic-addon1">
